...
func bounce():
	...
	tween2.tween_property($speaker_2, "scale", Vector2(1,1), 0.5).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
	tween1.tween_property($speaker_1, "scale", Vector2(1,1), 0.5).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
	tween2.tween_property($speaker_2, "scale", Vector2(1.5,1.5), 0.1).set_trans(Tween.TRANS_BOUNCE)
	tween1.tween_property($speaker_1, "scale", Vector2(1.5,1.5), 0.1).set_trans(Tween.TRANS_BOUNCE)
	tween2.tween_property($speaker_2, "scale", Vector2(1,1), 0.5).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
	tween1.tween_property($speaker_1, "scale", Vector2(1,1), 0.5).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
