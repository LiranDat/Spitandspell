...
func bounce():
	...
	tween2.tween_property($speaker_2, "scale", Vector2(2,2), 0.1).set_trans(Tween.TRANS_BOUNCE)
	tween1.tween_property($speaker_1, "scale", Vector2(2,2), 0.1).set_trans(Tween.TRANS_BOUNCE)
